	...
	<body>
		...
		<div id="luar">
			...
			<div id="menu">
				<nav>
					<ul>
						...
						<?php } ?>
						<?php
						if ($_SESSION['Level'] == "Pasien" or $_SESSION['Level'] == "Pasien") {
						?>
			...
			<div id="footer">
				...
				<hr width="100%">
				<br>
				<font color="#FFFFFF" style="line-height:35px;"><img src="logo/home.png" width="20" height="20" align="center">&nbsp;&nbsp; Universitas Teknologi Digital Indonesia
					<br>
					<img src="logo/telepon.png" width="20" height="20" align="center">&nbsp;&nbsp; +62877 5965 9653
					<br>
					<img src="logo/email.png" width="20" height="20" align="center">&nbsp;&nbsp; rahmadani@gmail.com
					<br>
					<img src="logo/maps.png" width="20" height="30" align="center">&nbsp;&nbsp; Jl. Griyapuntadewa No.143 A
				</font>
			</div>
			<div id="copyright">
				<font color="#FFFFFF" size="2">Copyright © 2022 Rahma Dani</font>
			</div>
		</div>
